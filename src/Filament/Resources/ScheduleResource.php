...
class ScheduleResource extends Resource
{
        ...
        return $form
            ->schema([
                Section::make([
                    ...
                    ScheduleResource::getTableOptionRepeaterFields(),
    ...
    public static function getTableRepeaterField()
    {
        ...
        return $tableRepeaterClass::make('params')
    ...
    public static function getTableOptionRepeaterFields()
    {
        return TableRepeater::make('options_with_value')->label(__('filament-database-schedule::schedule.fields.options_with_value'))
            ->schema([
                Forms\Components\TextInput::make('value')->label(fn($get) => ucfirst($get('name')))->required(fn($get) => $get('required')),
